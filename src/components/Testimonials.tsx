...
const Testimonials = () => {
  return (
    <div className='dark w-full'><section className="dark:bg-gray-100 dark:text-gray-800">
					...
					<div className="grid content-center gap-4">
						<div className="p-6 rounded shadow-md dark:bg-gray-50">
							...
							<div className="flex items-center mt-4 space-x-4">
								<img src="/virgo.png" alt="" className="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500" />
								<div>
